...
Finally, some action, let's see 
 ...
 --if the lock is free try to perform compare exchange, if the **current** value of the word equals the read value of oldWord, replca
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU5ODgwMTU4LC0xMzI4OTI2MjE3LC0xNT
